...
public enum TableTypeEnum {
     ...
     * 人脸归档
     */
    FaceArchive("face_archive","faceid_idx.(faceid)|peopleid_idx.(peopleid)|timestamp_idx.(timestamp)|" +
            "join_idx.(deviceid,tollgateid,type)","viid_facestatic.face_archive"),
    /**
     * Wifi:终端功能
     */
    TerminalFeature("terminal_feature","record_id_idx.(record_id)|mac_idx.(mac)|capture_time_idx.(capture_time)|" +
